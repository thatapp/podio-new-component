...
var s3client = require('s3').getClient(process.env.S3_BUCKET || 'my-bucket');
...
exports.process = function createItem(msg, cfg, next, snapshot) {
    var that = this;
    var item = _.cloneDeep(msg.body);
