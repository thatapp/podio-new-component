...
exports.process = async function updateItem(msg, cfg) {
    ...
    try {
        ...
        // if (data.date.start_date_utc === "[]") {
        //     data.date.start_date_utc === [];
        // }
        // if (data.date.end_date_utc === "[]") {
        //     data.date.end_date_utc === [];
        // }
        ...
        //     data.date.end_date === [];
        // }
        // if (data.date.start_time_utc === "[]") {
        //     data.date.start_time_utc === [];
        // }
        // if (data.date.end_time_utc === "[]") {
        //     data.date.end_time_utc === [];
        // }
        // if (data.date.start_time === "[]") {
        //     data.date.start_time === [];
        // }
        // if (data.date.end_time === "[]") {
        //     data.date.end_time === [];
        // }
        // if (data.date.start === "[]") {
        //     data.date.start === [];
