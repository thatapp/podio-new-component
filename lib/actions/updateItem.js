...
exports.process = async function updateItem(msg, cfg) {
    ...
    console.log("Update Item MSG" + JSON.stringify(msg.body));

    var podio = new Podio(cfg);

    var transformedApp = transformFields(item);
    ...
    async function updateItem(data, files) {
        ...
        var items = await podio.put('/item/' + item_id, data).fail(messages.emitError.bind(that));
