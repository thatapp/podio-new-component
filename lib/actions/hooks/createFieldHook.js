...
exports.process = async function createFieldHook(msg, cfg) {
    const that = this;
    ...
    const response = [];
    const endpoint = '/hook/app_field/' + refId;
    ...
    for (const type of types) {
        try {
            ...
            console.error('Failed to create field hook:', error.message || error);
